...
var Settings=React.createClass({
  ...
  render(){
    ...
    if (props.edit)
      extra_buttons=(
        <HoldButton className="ui item" onHoldClick={props.onDelete}>Delete project <i className="ui icon trash"/></HoldButton>
      )
          ...
          <form className="ui form" ref="form">
            <div className="field">
              ...
              <input type="text" name="name" ref="name"
                ...
                placeholder="Ex. My company name, web projects, external projects..."/>
            </div>
            <div className="field">
              <label>Shortname</label>
              <div className="ui meta">This name is used as a Serverboard identifier and is autogenerated.</div>
              <input type="text" name="shortname" disabled="true" ref="shortnane"
            ...
            <div className="field">
              <button type="submit" className="ui button positive">{props.edit ? "Update project" : "Create project" }</button>
            </div>
          </form>
          {props.children}
        </div>
