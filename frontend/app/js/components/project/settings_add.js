      ...
      <div className="ui background white central">
        <div className="ui text container" style={{marginTop:20}}>
          <form className="ui form" ref="form">
            ...
            <div className="field">
              <label>{i18n("Shortname")}</label>
              <div className="ui meta">{i18n("This name is used as a Serverboard identifier and is autogenerated.")}</div>
              <input type="text" name="shortname" disabled="true" ref="shortnane"
                value={this.state.shortname}
                placeholder={i18n("Ex. CMPNY")}/>
            </div>
            <div className="field">
              <label>{i18n("Tags")}</label>
              <input type="text" name="tags"
                defaultValue={project.tags.join(' ')}
                placeholder={i18n("Ex. web, mail, external...")}/>
            </div>
            <div className="field">
            ...
            <div className="field">
              <button type="submit" className="ui button positive">{props.edit ? i18n("Update project") : i18n("Create project") }</button>
            </div>
          </form>
          {props.children}
        </div>
